...
public class GlossyButton extends JButton {
	...
	private int buttonTheme = Theme.GRADIENT_BLACK_THEME;
	private int rollOverTheme = Theme.GLOSSY_SILVER_THEME;
	private int selectedTheme = Theme.GLOSSY_RED_THEME;;
	...
	private void drawShape(Graphics2D g2d, int w, int h) {
            switch (buttonType) {
                case ButtonType.BUTTON_ROUNDED_RECTANGLUR:
                    {
                ...
                case ButtonType.BUTTON_RECTANGULAR:
