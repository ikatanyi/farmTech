...
public class Test {
	public static void main(String args[]) {
		...
		GlossyButton rectBtn = new GlossyButton("",Theme.GLOSSY_SILVER_THEME,ButtonType.BUTTON_ROUNDED_RECTANGLUR);
		GlossyButton roundRectBtn = new GlossyButton("",Theme.GLOSSY_LIGHTBLUE_THEME,ButtonType.BUTTON_ROUNDED_RECTANGLUR);
		GlossyButton roundedBtn = new GlossyButton("Glossy Button",Theme.GLOSSY_ORANGE_THEME,ButtonType.BUTTON_ROUNDED);
		CircularGlossyButton circularBtn = new CircularGlossyButton("circle",Theme.GLOSSY_BLUE_THEME);
		
		//GlossyButton roundedBtn = new GlossyButton("Glossy Button",Theme.GLOSSY_ORANGE_THEME,ButtonType.BUTTON_ROUNDED);

		rectBtn.setPreferredSize(new Dimension(120,30));
		roundRectBtn.setPreferredSize(new Dimension(120,30));
		roundedBtn.setPreferredSize(new Dimension(140,30));
		circularBtn.setPreferredSize(new Dimension(80,80));

		JFrame frame = new JFrame("Custom Buttons Demo");
		 frame.setLayout(new FlowLayout());

		frame.add(rectBtn);
		frame.add(roundRectBtn);
		frame.add(roundedBtn);
	...
	public JPanel getButtonsPanel() {
		 ...
		 * Theme.GLOSSY_BLUEGREEN_THEME); blueGreen_Btn.setPreferredSize(new
		 * Dimension(130, 35));
		 * 
		 * GlossyButton green_Btn = new GlossyButton("Glossy Button",
		 * Theme.GLOSSY_GREEN_THEME); green_Btn.setPreferredSize(new
		 * Dimension(130, 35));
		 * 
		 * GlossyButton lightGreen_Btn = new GlossyButton("Glossy Button",
		 * Theme.GLOSSY_LIGHTGREEN_THEME); lightGreen_Btn.setPreferredSize(new
		 * Dimension(130, 35));
		 * 
		 * GlossyButton standardButton = new GlossyButton("Glossy Button",
		 * Theme.GLOSSY_LIME_THEME); standardButton.setPreferredSize(new
		 * Dimension(130, 35));
		 * 
		 * GlossyButton olive_Btn = new GlossyButton("Glossy Button",
		 * Theme.GLOSSY_OLIVEGREEN_THEME); olive_Btn.setPreferredSize(new
		 * Dimension(130, 35));
		 * 
		 * GlossyButton red_Btn = new GlossyButton("RollOver Button",
		 * Theme.GLOSSY_RED_THEME); red_Btn.setPreferredSize(new Dimension(130,
		 * 35));
		 * 
		 * GlossyButton darkRed_Btn = new GlossyButton("RollOver Button",
		 * Theme.GLOSSY_DARKRED_THEME); darkRed_Btn.setPreferredSize(new
		 * Dimension(130, 35));
		 * 
		 * GlossyButton orange_Btn = new GlossyButton("Glossy Button",
		 * Theme.GLOSSY_ORANGE_THEME); orange_Btn.setPreferredSize(new
		 * Dimension(130, 35)); orange_Btn.setEnabled(true);
		 * 
		 * GlossyButton lightOrange_Btn = new GlossyButton("GlossyButton",
		 * Theme.GLOSSY_LIGHTORANGE_THEME); lightOrange_Btn.setPreferredSize(new
		 * Dimension(130, 35));
		 * 
		 * GlossyButton darkYellow_Btn = new GlossyButton("Glossy Button",
		 * Theme.GLOSSY_DARKYELLOW_THEME); darkYellow_Btn.setPreferredSize(new
		 * Dimension(130, 35));
		 * 
		 * GlossyButton greenYellow_Btn = new GlossyButton("GlossyButton",
		 * Theme.GLOSSY_GREENYELLOW_THEME); greenYellow_Btn.setPreferredSize(new
		 * Dimension(130, 35));
		 * 
		 * GlossyButton goldYellow_Btn = new GlossyButton("Glossy Button",
		 * Theme.GLOSSY_GOLD_THEME); goldYellow_Btn.setPreferredSize(new
		 * Dimension(130, 35));
		 * 
		 * GlossyButton yellow_Btn = new GlossyButton("Yellow GlossyButton",
		 * Theme.GLOSSY_YELLOW_THEME); yellow_Btn.setPreferredSize(new
		 * Dimension(130, 35));
		 * 
		 * GlossyButton brown_Btn = new GlossyButton("GlossyButton",
		 * Theme.GLOSSY_BROWN_THEME); brown_Btn.setPreferredSize(new
		 * Dimension(130, 35)); GlossyButton lightbrown_Btn = new
		 * GlossyButton("GlossyButton", Theme.GLOSSY_LIGHTBROWN_THEME);
		 * lightbrown_Btn.setPreferredSize(new Dimension(130, 35)); GlossyButton
		 * palebrown_Btn = new GlossyButton("GlossyButton",
		 * Theme.GLOSSY_PALEBROWN_THEME); palebrown_Btn.setPreferredSize(new
		 * Dimension(130, 35));
		 * 
		 * GlossyButton navyblue_Btn = new GlossyButton("Glossy Button",
		 * Theme.GLOSSY_NAVYBLUE_THEME); navyblue_Btn.setPreferredSize(new
		 * Dimension(130, 35));
		 * 
		 * GlossyButton indigo_Btn = new GlossyButton("Glossy Button",
		 * Theme.GLOSSY_INDIGO_THEME); indigo_Btn.setPreferredSize(new
		 * Dimension(130, 35));
		 * 
		 * GlossyButton blue_Btn = new GlossyButton("Glossy Button",
		 * Theme.GLOSSY_BLUE_THEME); blue_Btn.setPreferredSize(new
		 * Dimension(130, 35));
		 * 
		 * GlossyButton skyBlue_Btn = new GlossyButton("Glossy Button",
		 * Theme.GLOSSY_SKYBLUE_THEME); skyBlue_Btn.setPreferredSize(new
		 * Dimension(130, 35));
		 * 
		 * GlossyButton lightBlue_Btn = new GlossyButton("Disable Button",
		 * Theme.GLOSSY_LIGHTBLUE_THEME); lightBlue_Btn.setPreferredSize(new
		 * Dimension(130, 35));
		 * 
		 * GlossyButton voilet_Btn = new GlossyButton("Disable Button",
		 * Theme.GLOSSY_VOILET_THEME); voilet_Btn.setPreferredSize(new
		 * Dimension(130, 35));
		 * 
		 * GlossyButton darkPurple_Btn = new GlossyButton("Glossy Button",
		 * Theme.GLOSSY_DARKPURPLE_THEME); darkPurple_Btn.setPreferredSize(new
		 * Dimension(130, 35));
		 * 
		 * GlossyButton purple_btn = new GlossyButton("Glossy Button",
		 * Theme.GLOSSY_PURPLE_THEME); purple_btn.setPreferredSize(new
		 * Dimension(130, 35));
		 * 
		 * GlossyButton lavendar_Btn = new GlossyButton("Standard Button",
		 * Theme.GLOSSY_LAVENDER_THEME); lavendar_Btn.setPreferredSize(new
		 * Dimension(130, 35));
		 * 
		 * GlossyButton darkPink_BTN = new GlossyButton("Glossy Button",
		 * Theme.GLOSSY_DARKPINK_THEME); darkPink_BTN.setPreferredSize(new
		 * Dimension(130, 35));
		 * 
		 * GlossyButton pink_Btn = new GlossyButton("Glossy Button",
		 * Theme.GLOSSY_PINK_THEME); pink_Btn.setPreferredSize(new
		 * Dimension(130, 35));
		 * 
		 * GlossyButton palePink_btn = new GlossyButton("Glossy Button",
		 * Theme.GLOSSY_PALEPINK_THEME); palePink_btn.setPreferredSize(new
		 * Dimension(130, 35));
		 * 
		 * GlossyButton black_Btn = new GlossyButton("Pressed Button",
		 * Theme.GLOSSY_BLACK_THEME); black_Btn.setPreferredSize(new
		 * Dimension(130, 35));
		 * 
		 * GlossyButton gray_Btn = new GlossyButton("Glossy Button",
		 * Theme.GLOSSY_GRAY_THEME); gray_Btn.setPreferredSize(new
		 * Dimension(130, 35));
		 * 
		 * GlossyButton lightGray_Btn = new GlossyButton("Glossy Button",
		 * Theme.GLOSSY_LIGHTGRAY_THEME); lightGray_Btn.setPreferredSize(new
		 * Dimension(130, 35));
		 * 
		 ...
		 * Theme.GLOSSY_BLUEGRAY_THEME); blueGray_Btn.setPreferredSize(new
		 * Dimension(130, 35));
		 * 
		 * GlossyButton silver_Btn = new GlossyButton("Glossy Button",
		 * Theme.GLOSSY_MULTIRED_THEME); silver_Btn.setPreferredSize(new
		 * Dimension(130, 35));
		 * 
		 * panel.add(darkGreen_Btn); panel.add(blueGreen_Btn);
		 * panel.add(green_Btn); panel.add(lightGreen_Btn);
		 * panel.add(olive_Btn);
		 * 
		 * panel.add(standardButton); panel.add(red_Btn);
		 * panel.add(darkRed_Btn); panel.add(orange_Btn);
		 * panel.add(lightOrange_Btn);
		 * 
		 * panel.add(darkYellow_Btn); panel.add(greenYellow_Btn);
		 * panel.add(goldYellow_Btn); panel.add(yellow_Btn);
		 * panel.add(brown_Btn); panel.add(lightbrown_Btn);
		 * panel.add(palebrown_Btn);
		 * 
		 * panel.add(navyblue_Btn); panel.add(indigo_Btn); panel.add(blue_Btn);
		 * panel.add(skyBlue_Btn); panel.add(lightBlue_Btn);
		 * panel.add(voilet_Btn);
		 * 
		 * panel.add(darkPurple_Btn); panel.add(purple_btn);
		 * panel.add(lavendar_Btn);
		 * 
		 * panel.add(darkPink_BTN); panel.add(pink_Btn);
		 * panel.add(palePink_btn); panel.add(black_Btn); panel.add(gray_Btn);
		 * panel.add(lightGray_Btn); panel.add(metallicGray_Btn);
		 * panel.add(blueGray_Btn); panel.add(silver_Btn);
		 */
	...
	private ArrayList<Integer> createThemesList() {
		ArrayList<Integer> themesList = new ArrayList<>();
