...
import com.jd.swing.custom.component.panel.GradientPanel;
...
import custom_jPanels.GlossyCurvedPanel;
import custom_jPanels.StandardCurvedPanel;
import custom_jPanels.TitlePanel;
...
//		cardLayoutPanel.add("Simple Glossy", createHeadingPanel());
	...
	public JTabbedPane createStandardPanels() {
		...
		for (Integer theme : themes) {
			...
			StandardPanel roundRectPnl = new StandardPanel(theme,PanelType.PANEL_RECTANGULAR);
	...
	public JTabbedPane createGradientPanels() {
		...
		for (Integer theme : themes) {
			...
			GradientPanel roundRectPnl = new GradientPanel(theme,PanelType.PANEL_ROUNDED_RECTANGLUR);
			rectPnl.setPreferredSize(new Dimension(200, 100));
			roundRectPnl.setPreferredSize(new Dimension(150, 150));
			rectMainPanel.add(rectPnl);
			roundRectMainPanel.add(roundRectPnl);
	...
	public JTabbedPane createSimpleGlossyPanels() {
		...
		for (Integer theme : themes) {
			...
			SimpleGlossyPanel roundRectPnl = new SimpleGlossyPanel(theme,PanelType.PANEL_ROUNDED_RECTANGLUR);
...
//			tree.setCellRenderer(new MyTreeCellRendrer());
			TitlePanel titlepanel = new TitlePanel("Glossy TitlePanel", theme, tree,"images/16_graph_multicolor.png");
			...
			TitlePanel titlepanel2 = new TitlePanel("Glossy TitlePanel", theme,tree2, "images/16_graph_multicolor.png");
		...
		for (Integer theme : standardthemes) {
			...
			TitlePanel titlepanel = new TitlePanel("Standard TitlePanel",theme,tree,"images/16_graph_multicolor.png");
			titlepanel.setPreferredSize(new Dimension(300, 180));
			...
			TitlePanel titlepanel2 = new TitlePanel("Standard TitlePanel",theme, tree2, "/images/16_graph_multicolor.png");
			titlepanel2.setPreferredSize(new Dimension(300, 180));
			stdroundRectPanel.setBorder(BorderFactory.createEmptyBorder(5, 5, 5, 5));
		...
		for (Integer theme : gradientThemes) {
			...
			TitlePanel titlepanel = new TitlePanel("Gradient TitlePanel",theme, tree,"/images/16_graph_multicolor.png");
			titlepanel.setPreferredSize(new Dimension(300, 180));
			gradrectPanel
			...
			TitlePanel titlepanel2 = new TitlePanel("Gradient TitlePanel",
					theme, tree2,"images/16_graph_multicolor.png");
			titlepanel2.setPreferredSize(new Dimension(300, 180));
