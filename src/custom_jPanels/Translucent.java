...
public class Translucent extends JPanel {
	...
	private int theme = Theme.GLOSSY_BLACK_THEME;//GRADIENT_LAVENDER_THEME;//STANDARD_BLACK_THEME;
	...
	public Translucent(int theme) {
        ...
        public Translucent(int theme,String title) {
            super();
           this.theme = theme;
           this.title= title;
	}
	...
	public void paintComponent(Graphics g2) {
		...
		//Set Transparency
		newComposite = AlphaComposite.getInstance(AlphaComposite.SRC_OVER, .8f);
		g.setComposite(newComposite);
