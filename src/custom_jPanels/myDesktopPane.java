...
public class myDesktopPane extends javax.swing.JDesktopPane
{
	 ...
	 */
	public myDesktopPane(Image image, int style)
	{
            super();
		setImage( image );
		setStyle( style );
//		setLayout( new BorderLayout() );
	 ...
	 */
	public myDesktopPane(Image image, int style, float alignmentX, float alignmentY)
	{
		setImage( image );
		setStyle( style );
	 ...
	 */
	public myDesktopPane(Paint painter)
	{
		setPaint( painter );
		setLayout( new BorderLayout() );
	}
