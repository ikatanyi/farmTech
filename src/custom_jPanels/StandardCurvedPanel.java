 ...
 * 
 */
public class StandardCurvedPanel extends JPanel {
	 ...
	 *            text of the panel.
	 */
	public StandardCurvedPanel(String title) {
		this.title = title;
		init();
	}
	 ...
	 *            theme of the panel
	 */
	public StandardCurvedPanel(int theme) {
		this.theme = theme;
		init();
	}
	 ...
	 *            theme of the panel
	 */
	public StandardCurvedPanel(String title, int theme) {
		this.title = title;
		this.theme = theme;
		init();
	}
	 ...
	 *            text color
	 */
	public StandardCurvedPanel(String title, int theme, Color textColor) {
		this.title = title;
		this.theme = theme;
