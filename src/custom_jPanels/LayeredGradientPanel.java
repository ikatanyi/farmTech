...
/*** * LayeredGradientPanel.java <p/> An example of for custom Layered Gradient* JPanel.* *
 @author JDhilsukh* */
 
    public class LayeredGradientPanel extends JPanel 
    {
    private String title;
    public LayeredGradientPanel() 
    {
      super();
      title="";
    }
    
    public LayeredGradientPanel(String title) 
    {
    super();
    this.title=title;
    }
    ...
    g.setPaint(paint);
    g.fill(shape);
    g.setFont(new Font("Microsoft Sanserif",Font.BOLD,18));
    g.setColor(new Color(0,0,0));
    g.drawString(title, width/4+1, 31);
    g.setColor(new Color(0,255,0));
    g.drawString(title, width/4, 31);
}
